...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapState)(["user"])), (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(["statusUser"])),
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              if (_this.email !== ((_this$$store$state$us = _this.$store.state.user) === null || _this$$store$state$us === void 0 ? void 0 : _this$$store$state$us.email)) data.email = _this.email;
              if (_this.firstName !== ((_this$$store$state$us2 = _this.$store.state.user) === null || _this$$store$state$us2 === void 0 ? void 0 : _this$$store$state$us2.first_name)) data.first_name = _this.firstName;
              if (_this.lastName !== ((_this$$store$state$us3 = _this.$store.state.user) === null || _this$$store$state$us3 === void 0 ? void 0 : _this$$store$state$us3.last_name)) data.last_name = _this.lastName;
              if (_this.number !== ((_this$$store$state$us4 = _this.$store.state.user) === null || _this$$store$state$us4 === void 0 ? void 0 : _this$$store$state$us4.number)) data.number = _this.number;
              if (_this.address !== ((_this$$store$state$us5 = _this.$store.state.user) === null || _this$$store$state$us5 === void 0 ? void 0 : _this$$store$state$us5.address)) data.address = _this.address;
              if (!(_this.newPassword !== ((_this$$store$state$us6 = _this.$store.state.user) === null || _this$$store$state$us6 === void 0 ? void 0 : _this$$store$state$us6.newPassword) && _this.newPassword)) {
                _context.next = 10;
                break;
              }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, "Выйти")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [_hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [_hoisted_10, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_11, [_hoisted_12, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    type: "text",
    "class": "form-control",
    id: "firstName",
    placeholder: "Иван",
