                        ...
                        <form class="form-horizontal" action="{{ route('country.update', $country->id) }}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control col" id="name" name="name" value="{{ old('name') ?? $country->name }}" placeholder="Россия" required>
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control col" id="abbreviation" name="abbreviation" required
