                    ...
                    <div id="accordion">
                        <div class="card card-info">
                            ...
                            <div class="card-body" style="display: block;">
                                <div class="row">
                                    <div class="col">
                                        <h4>Действия со странами</h4>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <a href="{{ route('country.create') }}" class="btn btn-outline-primary">Добавить</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    @foreach ($countries as $country)
                                        <tr class="d-flex">
                                            <td class="col-2">{{ $country->id }}</td>
                                            <td class="col-6 text-truncate">{{ $country->name }}</td>
