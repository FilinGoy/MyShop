                        ...
                        <form class="form-horizontal" action="{{ route('country.store') }}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control col" id="name" name="name" value="{{ old('name') }}" placeholder="Россия">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control col" id="abbreviation" name="abbreviation" placeholder="RUS" maxlength="3">
