...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Единицы измерения времени</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                <tbody>
                                    @foreach ($types as $type)
                                        <tr class="d-flex">
                                            ...
                                            <td class="col-3">
                                                <div>
                                                    <a href="{{ route('time.show', $type->id) }}" class="btn btn-outline-info btn-flat">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('time.edit', $type->id) }}" class="btn btn-outline-warning btn-flat">
                                                        <i class="fas fa-pen"></i>
                                                    </a>
                                                    <form action="{{ route('time.delete', $type->id) }}" id="deleteForm{{ $type->id }}" method="post" hidden>
                                                        @csrf
                                                        @method('delete')
                                                    </form>
