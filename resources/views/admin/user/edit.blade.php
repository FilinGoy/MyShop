                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control col" id="login" name="login"
                                        value="{{ old('login') ?? $user->login }}" placeholder="Логин" minlength="4"
                                        required>
                                    @if ($errors->has('login'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control col" id="number" name="number"
                                        ...
                                        inputmode="text" value="{{ old('number') ?? $user->number }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control col" id="password" name="password"
                                        value="{{ $user->password ?? old('password') }}" placeholder="Пароль">
