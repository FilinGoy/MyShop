...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Редактировать единицу измерения веса</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="card card-warning">
                        ...
                        <form class="form-horizontal" action="{{ route('weight.update', $type->id) }}" method="post">
                            @csrf
                            @method('patch')
                            <div class="card-body">
                                <h4>{{ $type->title }}</h4>
                            ...
                            <div class="card-footer">
                                ...
                                <a type="button" href="{{ route('weight.index') }}" class="btn btn-outline-danger float-right">Отменить</a>
                            </div>
                        </form>
                    </div>
                </div>
